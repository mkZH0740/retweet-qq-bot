            ...
            if (req.body['code'] === 3) {
                ...
                await page.$$eval('div[lang]', (elements, tagData, translation, style) => {
                    ...
                    for (const key in translation) {
                        ...
                        let tagSegment = document.createElement('span');
                        tagSegment.style.fontFamily = "黑体";
                        tagSegment.style.color = "blue";
                        tagSegment.append("由");
                        let tagImg = document.createElement('img');
                        tagImg.src = tagData;
                        tagImg.style.height = "28px";
                        tagImg.style.width = "28px";
                        tagSegment.appendChild(tagImg);
                        tagSegment.append("翻译自日文：");
